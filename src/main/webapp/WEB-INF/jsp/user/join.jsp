    ...
    <div class="container" align="center">
      <div class="row">
        ...
        <form action="${pageContext.request.contextPath}/join" method="post" class="form-horizontal" style="width: 20%">
          ...
          <div class="form-group">
            <div style="text-align: left">
              <label for="password"><font style="font-weight: normal; color: #F00;">*</font><font style="font-weight: normal; color: #666;">密码确认</font></label>
            </div>
            <input type="password" class="form-control" id="password" name="password" placeholder="请再次输入你的密码">
          </div>
